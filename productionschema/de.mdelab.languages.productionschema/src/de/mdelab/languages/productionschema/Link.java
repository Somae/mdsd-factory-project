 ...
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.languages.productionschema.Link#getSourceNode <em>Source Node</em>}</li>
 *   <li>{@link de.mdelab.languages.productionschema.Link#getDestinationNode <em>Destination Node</em>}</li>
 *   <li>{@link de.mdelab.languages.productionschema.Link#getAssociatedMaterial <em>Associated Material</em>}</li>
 * </ul>
 *
 * @see de.mdelab.languages.productionschema.ProductionschemaPackage#getLink()
 * @model
 * @generated
 */
public interface Link extends IdentifiableElement {
	 ...
	 * @see de.mdelab.languages.productionschema.ProductionschemaPackage#getLink_SourceNode()
	...
	/**
	 * Sets the value of the '{@link de.mdelab.languages.productionschema.Link#getSourceNode <em>Source Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.mdelab.languages.productionschema.ProductionschemaPackage#getLink_DestinationNode()
	...
	/**
	 * Sets the value of the '{@link de.mdelab.languages.productionschema.Link#getDestinationNode <em>Destination Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.mdelab.languages.productionschema.ProductionschemaPackage#getLink_AssociatedMaterial()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.mdelab.languages.productionschema.Link#getAssociatedMaterial <em>Associated Material</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
