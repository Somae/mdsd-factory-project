	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FactoryPackage.FACTORY_SPECIFICATION: {
				...
				if (result == null) result = caseIdentifiableElement(factorySpecification);
			...
			case FactoryPackage.FACTORY: {
				...
				if (result == null) result = caseIdentifiableElement(factory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FactoryPackage.MACHINE: {
				...
				if (result == null) result = caseIdentifiableElement(machine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FactoryPackage.EMPLOYEE: {
				...
				if (result == null) result = caseIdentifiableElement(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FactoryPackage.PRODUCT: {
				...
				if (result == null) result = caseIdentifiableElement(product);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
