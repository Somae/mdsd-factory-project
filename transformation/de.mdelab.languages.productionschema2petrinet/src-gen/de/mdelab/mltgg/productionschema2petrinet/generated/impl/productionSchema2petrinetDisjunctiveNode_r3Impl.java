...
import de.mdelab.mltgg.productionschema2petrinet.generated.productionSchema2petrinetDisjunctiveNode_r3;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>production Schema2petrinet Disjunctive Node r3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getConflictCheckForwardActivity <em>Conflict Check Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getConflictCheckMappingActivity <em>Conflict Check Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getConflictCheckBackwardActivity <em>Conflict Check Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getRepairForwardActivity <em>Repair Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.mltgg.productionschema2petrinet.generated.impl.productionSchema2petrinetDisjunctiveNode_r3Impl#getRepairBackwardActivity <em>Repair Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class productionSchema2petrinetDisjunctiveNode_r3Impl extends OperationalRuleImpl
		implements productionSchema2petrinetDisjunctiveNode_r3 {
	/**
	 ...
	 * @generated
	 */
	protected productionSchema2petrinetDisjunctiveNode_r3Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.eINSTANCE.getproductionSchema2petrinetDisjunctiveNode_r3();
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__ADD_ELEMENT_ACTIVITY,
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__MOVE_ELEMENT_ACTIVITY,
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__TRANSFORM_FORWARD_ACTIVITY,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__TRANSFORM_MAPPING_ACTIVITY,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public Activity getConflictCheckForwardActivity() {
		if (conflictCheckForwardActivity != null && conflictCheckForwardActivity.eIsProxy()) {
			...
			if (conflictCheckForwardActivity != oldConflictCheckForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CONFLICT_CHECK_FORWARD_ACTIVITY,
	...
	public Activity getConflictCheckMappingActivity() {
		if (conflictCheckMappingActivity != null && conflictCheckMappingActivity.eIsProxy()) {
			...
			if (conflictCheckMappingActivity != oldConflictCheckMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CONFLICT_CHECK_MAPPING_ACTIVITY,
	...
	public Activity getConflictCheckBackwardActivity() {
		if (conflictCheckBackwardActivity != null && conflictCheckBackwardActivity.eIsProxy()) {
			...
			if (conflictCheckBackwardActivity != oldConflictCheckBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CONFLICT_CHECK_BACKWARD_ACTIVITY,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public Activity getRepairForwardActivity() {
		if (repairForwardActivity != null && repairForwardActivity.eIsProxy()) {
			...
			if (repairForwardActivity != oldRepairForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__REPAIR_FORWARD_ACTIVITY,
	...
	public Activity getRepairBackwardActivity() {
		if (repairBackwardActivity != null && repairBackwardActivity.eIsProxy()) {
			...
			if (repairBackwardActivity != oldRepairBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__REPAIR_BACKWARD_ACTIVITY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CONFLICT_CHECK_FORWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckForwardActivity();
			return basicGetConflictCheckForwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CONFLICT_CHECK_MAPPING_ACTIVITY:
			if (resolve)
				return getConflictCheckMappingActivity();
			return basicGetConflictCheckMappingActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__CONFLICT_CHECK_BACKWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckBackwardActivity();
			return basicGetConflictCheckBackwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeBackwardActivity();
			return basicGetSynchronizeBackwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__REPAIR_FORWARD_ACTIVITY:
			if (resolve)
				return getRepairForwardActivity();
			return basicGetRepairForwardActivity();
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3__REPAIR_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___ADD_ELEMENT__EMAP:
			return addElement((EMap<String, Object>) arguments.get(0));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___MOVE_ELEMENT__TGGNODE_TGGNODE_TGGNODE:
			return moveElement((TGGNode) arguments.get(0), (TGGNode) arguments.get(1), (TGGNode) arguments.get(2));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___TRANSFORM_FORWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___TRANSFORM_MAPPING__TGGNODE_BOOLEAN_BOOLEAN:
			return transformMapping((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___TRANSFORM_BACKWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___CONFLICT_CHECK_FORWARD__TGGNODE:
			return conflictCheckForward((TGGNode) arguments.get(0));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___CONFLICT_CHECK_MAPPING__TGGNODE:
			return conflictCheckMapping((TGGNode) arguments.get(0));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___CONFLICT_CHECK_BACKWARD__TGGNODE:
			return conflictCheckBackward((TGGNode) arguments.get(0));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___SYNCHRONIZE_FORWARD__TGGNODE_BOOLEAN:
			return synchronizeForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___SYNCHRONIZE_BACKWARD__TGGNODE_BOOLEAN:
			return synchronizeBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___REPAIR_FORWARD__TGGNODE_BOOLEAN:
			return repairForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.PRODUCTION_SCHEMA2PETRINET_DISJUNCTIVE_NODE_R3___REPAIR_BACKWARD__TGGNODE_BOOLEAN:
			return repairBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //productionSchema2petrinetDisjunctiveNode_r3Impl
